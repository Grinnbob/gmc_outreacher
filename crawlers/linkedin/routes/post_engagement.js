 ...
 * /post/engagement:
 *   post:
 *     summary: Get Linkedin post information.
 *     description: Get Linkedin post information.
 *     requestBody:
 *          required: true
 *          content:
 *              application/json:
...
router.post("/post/engagement", async (req, res) => {
    ...
    try {
        ...
        try {
            ...
            throw new Error(
                `Can't save action for ${action_codes.linkedin_post_parsing} for user ${task.userId}: ${err}`
            )
        }
